...
2024-01-15 10:30:46 ERROR (MainThread) [test] Error message"""
    ...
    def test_parse_error_log_critical_included(self):
        ...
        log_text = """2024-01-15 10:30:45 CRITICAL (MainThread) [test] Critical message"""
...
KeyError: 'missing_key'"""
    ...
    def test_parse_error_log_limits_to_50(self):
        ...
        log_lines = []
        for i in range(60):
            log_lines.append(f"2024-01-15 10:{i:02d}:00 ERROR (MainThread) [test] Error {i}")
...
Additional context line"""
    ...
    async def test_get_errors_api_failure(self):
        ...
        with patch('ha_tools.lib.rest_api.ClientSession') as mock_session_class, \
             patch('aiohttp.TCPConnector') as mock_connector_class, \
             patch('ha_tools.lib.rest_api.print_warning') as mock_warning:
